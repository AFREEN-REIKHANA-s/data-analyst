...
# Load the datasets
daily_data = pd.read_csv('C:\\Users\\HP\\Downloads\\afree task\\daily_data.csv')
hourly_data = pd.read_csv('C:\\Users\\HP\\Downloads\\afree task\\hourly_data.csv')
monthly_data = pd.read_csv('C:\\Users\\HP\\Downloads\\afree task\\monthly_data.csv')
three_hour_data = pd.read_csv('C:\\Users\\HP\\Downloads\\afree task\\three_hour_data.csv')
